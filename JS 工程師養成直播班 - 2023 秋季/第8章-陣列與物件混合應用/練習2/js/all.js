...
//     console.log("你不能進入");
//     tomStatus.status = "你不能進入";
// }
// else{
//     console.log("你可以進入");
//     tomStatus.status = "你可以進入";
// }
...
//     peopleStatus[0].status = "你不能進入"
//     console.log("你不能進入")
// }
// else{
//     peopleStatus[0].status = "你可以進入"
//     console.log("你可以進入")
// }
// console.log(peopleStatus[0])
...
studentInfo[0].score = 90

if(studentInfo[0].score >= 80){
    studentInfo[0].rate = "優秀"
}
else if(studentInfo[0].score >= 60){
    studentInfo[0].rate = "普通"
}
else if(studentInfo[0].score >= 0){
    studentInfo[0].rate = "不及格"
}
else{
    studentInfo[0].rate = "無法判定"
}
console.log(studentInfo[0])
console.log("小明的成績評等為" + studentInfo[0].rate)
...
data.forEach(function(item,index){
    if(item.sex == 'female'){
        console.log(`${item.name}是女生`);
        people.female += 1;
    }else{
        console.log(`${item.name}是男生`);
        people.male += 1;
    }
})
console.log(`男生有${people.male}位，女生有${people.female}位`); */
...
console.log(`免費充電站有${total.free}處，投幣式充電站有${total.paid}處`) */
...
console.log(`免費充電站有${total.free.length}個`);
console.log(`投幣式充電站有${total.paid.length}個`);
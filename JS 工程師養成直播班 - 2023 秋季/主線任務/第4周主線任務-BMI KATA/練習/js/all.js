...
function showHistoryData(){
    const totalData = bmiHistoryData.length;
    const lastData = bmiHistoryData[totalData-1];
    console.log(`您總共計算 ${totalData} 次 BMI 紀錄，最後一次 BMI 指數為${lastData.bmi} ，體重${lastData.state}！健康指數為${lastData.color}！`)
}
